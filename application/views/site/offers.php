    ...
    <div class='bg-green-500 pb-4 mt-6'>
      <div class="flex flex-col container mx-auto">
        ...
        <div class='flex flex-col lg:flex-row items-center justify-center mt-6 lg:-mt-6 text-white tracking-wide'>
          <a href="javascript:;">
            <img class='mr-4' src="<?= site_url('assets/images/instagram-logo.png')?>" alt="" srcset="">
          </a>
          <a href="javascript:;">
            <img class='mr-4' src="<?= site_url('assets/images/twitter-logo.png')?>" alt="" srcset="">
          </a>
          <a href="javascript:;">
            <img src="<?= site_url('assets/images/facebook-logo.png')?>" alt="" srcset="">
          </a>
        </div>
        <div class='flex flex-col lg:flex-row items-center justify-center mt-4 text-white tracking-wide'>
