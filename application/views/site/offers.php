...
<body class=bg-gray-200>
  <div class='bg-green-500 mb-6 pb-4'>
    <div class="flex flex-col container mx-auto">
      ...
      <div class='flex flex-row items-center justify-center -mt-4 text-xs text-white uppercase tracking-wide'>
  ...
  <div class="flex flex-row container mx-auto my-4" id='app'>
    <div class='flex flex-col justify-between bg-white w-1/3 mr-3 p-4 rounded border'>
    ...
    <div class='flex flex-row bg-white w-2/3 p-4 rounded border'>
      <div class='flex flex-col w-3/12 py-4'>
      ...
      <div class='flex flex-col w-5/12 p-4'>
      ...
      <div class='flex flex-row items-center justify-center w-4/12 p-4'>
