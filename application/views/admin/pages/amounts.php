<div id="app">
  ...
  <el-row :gutter='15'>
    <el-col :span='24'>
      <el-table :data="amounts" class="w-full" stripe size='mini' empty-text='No hay datos'>
        <el-table-column prop="index" min-width="25"></el-table-column>
        <el-table-column prop="from" label="Desde" min-width="100"></el-table-column>
        <el-table-column prop="until" label="Hasta" min-width="100"></el-table-column>
          ...
          <template slot-scope="scope">
            <el-dropdown trigger="click" class='my-1'>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item><i class="el-icon-edit-outline"></i> Editar monto</el-dropdown-item>
                <el-dropdown-item>
