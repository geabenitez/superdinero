<div id="app">
  <?php $this->load->view('admin/pages/dialogs/questionNew')  ?>
          ...
          <template slot-scope="scope">
            <el-dropdown trigger="click" class='my-1'>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="editQuestion(scope.row)">
                  <i class="el-icon-edit-outline"></i> Editar Pregunta
                </el-dropdown-item>
                ...
                <el-dropdown-item divided class='font-semibold' @click.native="deleteQuestion(scope.row.id)">
                  <span class='text-red-500 tracking-wide'>
                    <i class="el-icon-delete"></i> Eliminar Pregunta
                  </span>
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
