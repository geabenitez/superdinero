<div id="app">
  <?php $this->load->view('admin/pages/dialogs/categoryNew')  ?>
  ...
  <el-row :gutter='15'>
    <el-col :span='24'>
      <el-table :data="filteredCategories" class="w-full" stripe size='mini' empty-text='No hay datos' v-loading="loading">
          ...
          <template slot-scope="scope">
            <el-dropdown trigger="click" class='my-1'>
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item divided class='font-semibold' @click.native="deleteCategory(scope.row.id)">
                  <span class='text-red-500 tracking-wide'>
                    <i class="el-icon-delete"></i> Eliminar categoria
                  </span>
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
