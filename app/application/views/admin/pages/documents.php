<div id="app">
  <?php $this->load->view('admin/pages/dialogs/documentNew')  ?>
  ...
  <el-row :gutter='15'>
    <el-col :span='24'>
      <el-table :data="filteredDocuments" class="w-full" stripe size='mini' empty-text='No hay datos' v-loading="loading">
          ...
          <template slot-scope="scope">
            <el-dropdown trigger="click" class='my-1'>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="editDocument(scope.row)">
                ...
                <el-dropdown-item divided class='font-semibold' @click.native="deleteDocument(scope.row.id)">
