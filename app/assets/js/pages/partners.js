  ...
  methods: {
    ...
    editPartner(partner) {
      ...
      this.newAsociateForm = {
        ...
        methods: partner.methods.map(m => m.id),
        ...
        paramValues1: partner.paramValues1 == "" ? [] : partner.paramValues1.split(','),
        paramValues2: partner.paramValues2 == "" ? [] : partner.paramValues2.split(','),
